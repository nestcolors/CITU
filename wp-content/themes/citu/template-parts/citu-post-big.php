<div class="col-xs-12">
    <a href="<?php echo get_the_permalink($item->ID) ?>" class="box-normal box-hover init-blog-item"><!-- init-blog-item -->
        ...
        <div class="post-text pull-right">
            ...
            <p class="small-text date pull-left"><?php echo get_the_date('d/m/Y',$item->ID); ?></p>
