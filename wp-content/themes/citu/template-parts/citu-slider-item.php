<a href="<?php get_the_permalink($item->ID) ?>" class="slide box-normal box-hover">
    ...
    <div class="post-text pull-right">
        <h4><?php get_the_title($item->ID); ?></h4>
        <p class="small-text date"><?php get_the_date('d/m/Y',$item->ID); ?></p>
