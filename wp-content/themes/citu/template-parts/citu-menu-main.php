<div class="pull-left">
    ...
    <div class="main-links hide-mobile">
        <a href="<?php echo AbvFunctions::set_pll_link('/its') ?>" class="itc <?php echo AbvFunctions::add_class_active('its') ?>"><span>Information & Communication<br>  Technology</span> <span class="nav-arrow white-arrow"></span></a>
